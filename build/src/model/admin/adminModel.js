...
exports.getAdminByEmailandUpdate = exports.getAdminByEmail = exports.getOneAdmin = exports.updateByJWT = exports.updateUser = exports.updateById = exports.getAdmin = exports.deleteAdmin = exports.addAdmin = void 0;
...
const updateByJWT = (jwt, obj) => {
    return adminSchema_1.default.findOneAndUpdate(jwt, obj, { new: true });
};
exports.updateByJWT = updateByJWT;
